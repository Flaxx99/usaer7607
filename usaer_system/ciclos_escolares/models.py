...
class CicloEscolar(models.Model):
    nombre = models.CharField("Nombre del ciclo", max_length=100, unique=True, help_text="Ej. 2024-2025")
    fecha_inicio = models.DateField("Fecha de inicio")
    fecha_fin = models.DateField("Fecha de fin")
    activo = models.BooleanField("Ciclo activo", default=False, help_text="Marcar solo si este es el ciclo escolar actual. Solo un ciclo puede estar activo a la vez.")
