...
class CicloEscolarViewsTest(APITestCase):
    def setUp(self):
        ...
        self.admin = User.objects.create_superuser(
            email="admin@test.com", numero_empleado="admin", password="pass", role=User.Role.ADMINISTRADOR
        )
        self.maestro = User.objects.create_user(
            email="user@test.com", numero_empleado="user1", password="pass", role=User.Role.MAESTRO_APOYO
        )
