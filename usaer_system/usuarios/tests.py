...
from .models import User, SystemConfiguration, CalendarEvent
...
class UserAPITests(APITestCase):
    def setUp(self):
        ...
        self.escuela = Escuela.objects.create(
            clave_estatal="111", cct="CCT111", nombre="Escuela Base", 
        ...
        self.maestro = User.objects.create_user(
            email="maestro@example.com", numero_empleado="maestro", 
            password="TestPass1!", role=User.Role.MAESTRO_APOYO, escuela=self.escuela
        )
        self.secretario = User.objects.create_user(
            email="sec@example.com", numero_empleado="sec1", 
            password="TestPass1!", role=User.Role.SECRETARIO, escuela=self.escuela
        )
...
class UserModelTests(APITestCase):
    ...
    def test_user_full_name(self):
        user = User.objects.create_user(
            email="test@test.com", numero_empleado="EMP_TEST", password="pass",
    ...
    def test_unique_constraints(self):
        ...
        User.objects.create_user(
            email="u1@test.com", numero_empleado="EMP1", password="pass"
        )
        # Try to create another user with same numero_empleado
        with self.assertRaises(Exception):
            User.objects.create_user(
                email="u2@test.com", numero_empleado="EMP1", password="pass"
            )

    def test_calendar_event_creation(self):
        user = User.objects.create_user(email="cal@test.com", numero_empleado="EMP_CAL", password="pass")
