...
class AsistenciaAPITests(APITestCase):
    ...
    def test_checar_entrada_exitosa(self):
        ...
        self.assertTrue(
            Asistencia.objects.filter(profesor=self.profesor, fecha=timezone.localdate()).exists()
        )
    ...
    def test_listar_asistencias_maestro_solo_lo_suyo(self):
        ...
        Asistencia.objects.create(
            profesor=self.profesor, escuela=self.escuela, fecha=timezone.localdate(), presente=True
        )
        Asistencia.objects.create(
            profesor=otro_profesor, escuela=self.escuela, fecha=timezone.localdate(), presente=True
        )
    ...
    def test_filtrar_asistencias_por_fecha(self):
        ...
        Asistencia.objects.create(
            profesor=self.profesor, escuela=self.escuela, fecha=hoy, presente=True
        )
        Asistencia.objects.create(
            profesor=self.profesor, escuela=self.escuela, fecha=ayer, presente=True
        )
    ...
    def test_buscar_asistencias_por_nombre(self):
        ...
        profesor_especifico = User.objects.create_user(
            ...
            numero_empleado="EMP_SPEC",
            password="pass",
            nombre="Zebulon",
            apellido_paterno="Zarathustra",
            escuela=self.escuela,
            role=User.Role.MAESTRO_APOYO,
        )
        Asistencia.objects.create(
            profesor=profesor_especifico,
            escuela=self.escuela,
            fecha=timezone.localdate(),
            presente=True,
        )
