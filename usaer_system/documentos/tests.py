...
class DocumentosAPITests(APITestCase):
    def setUp(self):
        ...
        self.maestro = User.objects.create_user(
            email="maestro_doc@example.com",
            numero_empleado="maestro_doc",
            password="pass",
    ...
    def test_lista_expedientes_maestro(self):
        ...
        self.assertTrue(
            any(
                self.alumno.get_full_name() in (item.get("alumno_nombre") or "") for item in results
            )
        )
    ...
    def test_acceso_denegado_a_expediente_ajeno(self):
        ...
        otro_maestro = User.objects.create_user(
            email="otro_doc@example.com",
            numero_empleado="otro_doc",
            password="pass",
            role=User.Role.MAESTRO_APOYO,
        )
