...
class AlumnoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Información académica"), {"fields": ("grado", "grupo", "escuela", "profesor")}),
        (_("Clasificación especial"), {"fields": ("clasificacion", "clasificacion_otro")}),
    )
    ...
    def clasificacion_display(self, obj):
        ...
        return format_html(
            '<span style="color: {};">{}</span>', color, obj.get_clasificacion_display()
        )
