...
class AlumnoAPITests(APITestCase):
    def setUp(self):
        ...
        self.secretario = User.objects.create_user(
            email="sec_alumnos@example.com",
            numero_empleado="sec_al",
            password="pass",
            role=User.Role.SECRETARIO,
            escuela=self.escuela,
        )
        self.maestro = User.objects.create_user(
            email="maestro_alumnos@example.com",
            numero_empleado="maestro_al",
            password="pass",
