...
class RegistroRACAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ["alumno", "maestro_apoyo", "escuela_regular", "escuela_basica"]
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not change:
            ...
            if obj.alumno:
                ...
                obj.grado = (
                    obj.alumno.grado_actual
                )  # Asegúrate que tu modelo Alumno tenga 'grado_actual'
