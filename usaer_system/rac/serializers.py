...
from .models import RegistroRAC, SERVICE_CHOICES, SUBCLASIFICACION_CHOICES
...
class RegistroRACSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            ...
            'zona_regular', 'curp', 'sexo', 'edad', 'grado'
        ]
    ...
    def validate(self, data):
        ...
        from .models import DISCAPACIDAD_SUB, DIFICULTADES_SUB, TRASTORNOS_SUB, APTITUDES_SUB
        valid_map = {
