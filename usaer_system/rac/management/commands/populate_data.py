...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        admin, created = User.objects.get_or_create(
            ...
            defaults={
                'first_name': 'Admin', 'last_name': 'USAER', 
                'role': 'ADMINISTRADOR', 'is_staff': True, 'is_superuser': True,
        ...
        secretario = User.objects.create_user(
            email='secretario@usaer.com', password='secretario123',
            first_name='Secretario', last_name='General', role='SECRETARIO', numero_empleado='SEC001'
        )
        self.stdout.write("   Secretario creado.")

        # Maestro de Apoyo 1
        maestra1 = User.objects.create_user(
            email='maestra1@usaer.com', password='maestra123',
            first_name='Laura', last_name='García', role='MAESTRO_APOYO', numero_empleado='MAE001'
        )
        maestra1.sexo = 'M' 
        maestra1.save()
        ...
        maestra2 = User.objects.create_user(
            email='maestra2@usaer.com', password='maestra123',
            first_name='Carlos', last_name='Pérez', role='MAESTRO_APOYO', numero_empleado='MAE002'
        )
        maestra2.sexo = 'H' 
        maestra2.save()
        ...
        escuela1 = Escuela.objects.create(
            nombre="Escuela Primaria Benito Juárez", cct="12DPR1234A", nivel="PRIMARIA", zona="052", clave_estatal="12DPR1234A"
        )
        escuela2 = Escuela.objects.create(
            nombre="Jardín de Niños Rosaura Zapata", cct="12DJN5678B", nivel="PREESCOLAR", zona="015", clave_estatal="12DJN5678B"
        )
        escuela3 = Escuela.objects.create(
            nombre="Escuela Secundaria Técnica 1", cct="12DST9012C", nivel="SECUNDARIA", zona="030", clave_estatal="12DST9012C"
        )
    ...
    def _create_students_for_teacher(self, teacher, school, count):
        for i in range(count):
            ...
            alumno = Alumno.objects.create(
                ...
                escuela=school,
                profesor=teacher,
                clasificacion=random.choice([choice[0] for choice in Alumno.CLASIFICACION_CHOICES]) # Asignar clasificación
            )
    ...
    def _create_random_rac(self, alumno, maestro):
        rac_fields = {
            ...
            if f.name.startswith(('discapacidad_', 'dificultad_', 'trastorno_', 'aptitud_', 'apoyo_', 'portafolio_'))
        }
