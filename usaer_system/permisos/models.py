...
class Permiso(models.Model):
    ...
    tipo = models.CharField(
        _("Tipo de permiso"), max_length=20, choices=Tipo.choices, default=Tipo.PERSONAL
    )
    ...
    estado = models.CharField(
        _("Estado"), max_length=10, choices=Estado.choices, default=Estado.PENDIENTE
    )
    ...
    fecha_respuesta = models.DateTimeField(
        _("Fecha de respuesta"), null=True, blank=True, editable=False
    )
    ...
    def clean(self):
        if self.fecha_fin and self.fecha_inicio and self.fecha_fin < self.fecha_inicio:
            raise ValidationError(
                _("La fecha de finalización no puede ser anterior a la fecha de inicio.")
            )
